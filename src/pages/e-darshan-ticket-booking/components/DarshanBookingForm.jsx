              ...
              <motion.button
                ...
                className={`p-3 rounded-lg text-center transition-sacred ${
                  isPast 
                    ...
                    : isSelected
                    ? 'sw1049-gradient text-white' :'bg-muted hover:bg-temple-gold/20 hover:border-temple-gold'
                }`}
              >
                  ...
                  <motion.div
                    ...
                    className={`border-2 rounded-lg p-4 cursor-pointer transition-sacred ${
                      !isAvailable
                        ...
                        : isSelected
                        ? 'border-sw1049-primary bg-sw1049-primary/10' :'border-border hover:border-temple-gold hover:bg-temple-gold/5'
                    }`}
                  ...
                  >
                    ...
                    <div className="mt-3 w-full bg-muted rounded-full h-2">
                      <div 
                        ...
                        style={{ 
                          width: `${Math.max(5, (slot?.available / slot?.total) * 100)}%` 
                        }}
                      />
                    </div>
                  </motion.div>
